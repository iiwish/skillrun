...
Implemented:
  ...
  team catalog inspect <catalog-path-or-url> [--json]
  team catalog status <catalog-path-or-url> [--json]
  team catalog install plan <catalog-path-or-url> <item-id> [--json]
  team catalog install apply <catalog-path> <item-id> [--json]
