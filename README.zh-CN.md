...
SkillRun v0.5.0 是当前 release candidate 版本。最近完成的本地 release handoff 是 v0.4.2；v0.5.0 定义 language-agnostic Adapter Protocol，并用 Level 0 command adapter 证明这条边界。

- 当前实现：v0.2 MCP stdio 行为、v0.3 JS Action Alpha、v0.4 Portable Consumer Checks、v0.4.1 WeCom Team Notice、v0.4.2 官方参考胶囊，以及 v0.5 Adapter Protocol 与 Level 0 command adapter runtime。
...
- v0.4.2 本地 release handoff 已完成。v0.5.0 merge、tag creation、remote push 和 package publication 仍然是 review approval 之后的单独显式决策。
