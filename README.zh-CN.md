...
SkillRun v0.2.0 已准备进入第一版 public release candidate 的用户审核。当前尚未打 tag，也尚未公开发布 package。

- 当前实现：v0.2 release-candidate 行为已经包含真实 MCP stdio server、`.skr` packaging 和 release-level validation。
...
- 在 release report 获得维护者接受之前，不应打 tag 或公开发布。
