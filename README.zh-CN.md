...
v0.5.6 release-polish line 增加 `skillrun consumer inventory --json`，作为第一个显式 headless consumer control-plane surface。它复用 registry readiness 语义，不引入 Desktop、daemon、sandbox、signed package trust 或 marketplace 能力。
